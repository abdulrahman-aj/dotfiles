...
<!-- Adapted from Anthropic's frontend-design. Added an existing-design-system safeguard
and normalized punctuation to ASCII. Source revision and changes: SOURCE.md. -->

# Frontend Design

When working in an existing product, preserve its design system and visual language
unless the user requests a redesign. Apply the guidance below within those constraints.
...
5. template chrome that appears whatever the subject: a tracked-out ALL-CAPS eyebrow label above every heading; meta strings joined with middle dots; labels built as a word and fragment separated by a spaced em dash; tinted near-black (#0B0B0B, #111) standing in for black; a monospace face for small data labels; a right arrow appended to link and button text.
